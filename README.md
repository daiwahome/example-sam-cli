...
This is a sample template for sam-cli-test - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-cli-test --query 'Stacks[].Outputs'
```
